...
namespace Mediapipe.HandTracking {
    public partial class Hand {
        ...
        public static Hand MakeFrom(float[] arr_landmark_data, HandRect hand_rect, Text mtext) {
            ...
            //string tmp = "";
            //for (int i = 0; i < raw_landmarks.Length - 1; i += 1)
            //{
            //    tmp += raw_landmarks[i];
            //}
            //Debug.Log("raw landmarks:" + tmp);

            //tmp = "";
            //for (int i = 0; i < normalize_landmarks.Length - 1; i += 1)
            //{
            //    tmp += normalize_landmarks[i];
            //}
            //Debug.Log("normalize landmarks:" + tmp);
...
//#endif
                {
                    Debug.Log("Reach depthEstimate if condition!");
