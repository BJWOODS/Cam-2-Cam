...
namespace Portalble.Functions.Grab {
    ...
    class GrabManipulationInfo {
        ...
        public void UpdateReleaseVelocity() {
            ...
            velList.Enqueue(releaseRawVelocity * 1f);
    ...
    public class Grab : MonoBehaviour {
        private static readonly float REGRAB_COOLDOWN = 3f;
        private static readonly float tipDisThreshold = 1.2f;
        /// <summary>
        ...
        private bool PORTALBLE_STUDY_FORCE_PAUSE = false;
        /// <summary>
        ...
        public bool UseMaterialChange {
            ...
            set {
                ...
                if (m_selectObj != null) {
                    //Placeholder for material-based manipulation feedback
        ...
        void Update() {
            ...
            //check if the object distance is too far so we have to release it
        ...
        public void Reset() {
            ...
            if (gobj != null) {
                ...
                if (m_tLeftHand != null){
                    /// TODO: need to change tip gameobject for metalhand_r in the future
        ...
        //TODO: Change the following gesture from pinch to only fist
        ...
        //buffered gesture may assist with smoothing
        ...
        private Vector3 getAverageVel(Queue<Vector3> q, int scaleFactor) {
            ...
            int beginIdx = Mathf.Max(0, t.Length - 19);
            int endIdx = t.Length;
            ...
            return (finalSpeed / Mathf.Max(endIdx - beginIdx, 1));
        }
        /// <summary>
        /// Stop to grab
        /// </summary>
        ...
        public Vector3 GetCurrentReleaseVelocity()
        {
            return getAverageVel(m_grabInfo.velList, 15);
        }
    }
}
