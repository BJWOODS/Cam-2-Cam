...
public class ChickenDemoController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (new_seed != null)
        {
            if (!new_seed.GetComponent<Grabable>().IsBeingGrabbed())
            {
    ...
    public void TaskSeedOnClick()
    {
        ...
        {
            Debug.Log("find motion" + GameObject.Find("Hand_r").GetComponent<GestureControl>().bufferedGesture());
    ...
    {
        chicken_prefab.GetComponent<Grabable>().m_grabbedMaterial = null;
        chicken_prefab.GetComponent<Grabable>().m_selectedMaterial = null;
        egg_prefab.GetComponent<Grabable>().m_grabbedMaterial = null;
        egg_prefab.GetComponent<Grabable>().m_selectedMaterial = null;
        PokeBall_prefab.GetComponent<Grabable>().m_grabbedMaterial = null;
        PokeBall_prefab.GetComponent<Grabable>().m_selectedMaterial = null;
        seed_prefab.GetComponent<Grabable>().m_grabbedMaterial = null;
        seed_prefab.GetComponent<Grabable>().m_selectedMaterial = null;
    }
}
