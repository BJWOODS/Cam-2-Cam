...
public class ChickenController : MonoBehaviour
{
    ...
    public float petEffectiveTime = 1f; // time to pet to trigger animation
    
    public Grabable grab;
    private bool touched;
    private int happiness = 0; // happiness score, reach 100 to lay an egg
    public GameObject FloatingText;

    public bool canmove; // enable and disable chicken ability to move
    ...
    public void find_and_eat(GameObject seed)
    {
        ...
        if (!seed.GetComponent<Grabable>().IsBeingGrabbed())
        {
